...
class middleware {
    ...
    private static singleFile = middleware.multerUpload.single("singleFile")
    private static attachmentsMulter = middleware.multerUpload.array("arrayFiles", 5)
     
    private static getBase64 = (file:any) =>`data:${file.mimetype};base64,${file.buffer.toString("base64")}`
    ...
    static SingleFile = AsyncHandler.wrap(middleware.singleFile);
    static AttachmentsMulter = AsyncHandler.wrap(middleware.attachmentsMulter);
